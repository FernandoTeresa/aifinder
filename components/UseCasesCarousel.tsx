    ...
    <section className="relative z-10 mx-auto max-w-6xl px-4 py-14">
      <div className="mb-4 flex items-center justify-between">
        ...
        <div className="hidden gap-2 md:flex">
          <button aria-label="Anterior" onClick={() => scrollByX(-360)} className="rounded-xl border p-2 hover:bg-white/60">
            <ArrowLeft className="h-4 w-4" />
          </button>
          <button aria-label="Seguinte" onClick={() => scrollByX(360)} className="rounded-xl border p-2 hover:bg-white/60">
